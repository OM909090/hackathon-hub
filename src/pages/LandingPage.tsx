...
const features = [
  {
    ...
    description: "Create teams, invite members, and manage your squad with college-based grouping.",
    color: "bg-info/10 text-info",
  },
  {
    icon: FolderUp,
    title: "Project Submission",
    description: "Submit code, presentations, and demos through seamless Google Drive integration.",
    color: "bg-success/10 text-success",
  },
  {
    icon: ClipboardCheck,
    title: "Two-Stage Evaluation",
    description: "Online project review followed by deep technical evaluation with weighted scoring.",
    color: "bg-accent/10 text-accent",
  },
  {
    icon: Shield,
    title: "Secure Platform",
    description: "OTP-based auth, JWT security, and role-based access for all participants.",
    color: "bg-warning/10 text-warning",
  },
  {
    icon: Zap,
    title: "Real-time Updates",
    description: "Live notifications via WebSocket for submissions, results, and announcements.",
    color: "bg-info/10 text-info",
  },
  {
    icon: Globe,
    title: "College Dashboard",
    description: "Dedicated dashboards for each college to track and manage their participants.",
    color: "bg-success/10 text-success",
  },
];
